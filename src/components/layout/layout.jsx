          ...
          <Header className="header">
            <Row>
              <Col span={21} className="statisticCol">
                ...
                {/* 农业项目 */}
                {/* <span>车位数：{charging !== null ? charging.used : 0}/{charging !== null ? charging.total : 0}</span> */}
                {/* <Divider type="vertical" /> */}
                {/* <span>充电桩数：{parking !== null ? parking.used : 0}/{parking !== null ? parking.total : 0}</span> */}
                {/* <Divider type="vertical" /> */}
              </Col>
              <Col span={3} style={{ lineHeight: '63px' }}>
                ...
                <a href="../SmartAgricultureScreen/" className="outSite">大屏</a>
              </Col>
            </Row>
